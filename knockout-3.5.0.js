  ...
  (function(p) {
      ...
      (function(p) {
          ...
          function ba(a, c) {
              var d = this.pd,
                  e = d[t];
              e.qa || (this.Pb && this.kb[c] ? (d.tc(c, a, this.kb[c]), this.kb[c] = null, --this.Pb) : e.F[c] || d.tc(c, a, e.G ? {
                  da: a
              } : d.Zc(a)), a.Ka && a.fd())
          }
          ...
          a.a = function() {
              ...
              return {
                  ...
                  Nd: function(c, d, e) {
                      e = e || {};
                      var k = e.params || {}, f = e.includeFields || this.Ic,
                          l = c;
              ...
              function b(b) {
                  ...
                  if (1 < d.length) {
                      for (var y = 0, A; A = d[y]; ++y) {
                          ...
                          } else if (47 === u && 1 < A.length && (47 === A.charCodeAt(1) || 42 === A.charCodeAt(1))) continue;
          ...
          a.f.value = {
              ...
              init: function(b, c, d) {
                  ...
                  if (!f || "checkbox" != b.type && "radio" != b.type) {
                      ...
                      !a.a.W || !f || "text" != b.type || "off" == b.autocomplete || b.form && "off" == b.form.autocomplete || -1 != a.a.A(g, "propertychange") || (a.a.H(b, "propertychange", function() {
                          m = !0
          ...
          a.ic = function() {
              function b(b, c, d, h) {
                  ...
                  d = "ko.__tr_ambtns(function($context,$element){return(function(){return{ " + a.m.ub(b, {
                      valueAccessors: !0
                  }) + " } })()},'" + d.toLowerCase() + "')";
          ...
          (function() {
              ...
              a.B.D.prototype.nodes = function() {
                  ...
                  if (0 == arguments.length) {
                      ...
                      if (!f || e.hd)
                          if (e = this.text()) f = a.a.Ld(e, b.ownerDocument), this.text(""), a.a.g.set(b, c, {
                              jb: f,
                              hd: !0
                          });
                      return f
          ...
          (function() {
              ...
              a.a.cc = function(e, f, g, h, m, l) {
                  ...
                  function n(b, c) {
                      if (b)
                          for (var d = 0, e = c.length; d < e; d++) a.a.C(c[d].Y, function(a) {
                              b(a, d, c[d].Aa)
                          })
                  }
                  f = f || [];
